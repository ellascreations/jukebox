  ...
  <div class="w-full max-w-md">
    ...
    <section class="neon-card mt-5 p-7 sm:p-8">
      ...
      <form class="mt-7 space-y-4" @submit.prevent="signIn">
        ...
        <div><label class="mb-2 block text-sm font-bold text-slate-300">Password</label><input v-model="password" class="neon-input" type="password" autocomplete="current-password" required></div>
